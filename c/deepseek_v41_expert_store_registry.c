 ...
 *
 * See deepseek_v41_expert_store_registry.h for the design. Registration happens from C
...
/* The built-in on-disk/mmap backend, defined in the COLI_V41_UNIT_EXPERT_STORE_AUTO
 * amalgamation unit of deepseek_v41.c. Declared here (not via its header, which
...
static void coli_register_auto_backend(void) {
    coli_expert_store_backend_register("auto",
                                       coli_v41_expert_store_open_planned);
}